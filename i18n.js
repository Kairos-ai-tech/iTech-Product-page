...
const translations = {
  "zh-TW": {
    ...
    "compliance.moat1.title": "不可竄改鏈式雜湊",
  ...
  "ja": {
    ...
    "compliance.moat1.desc": "各記録は SHA-256 で前の記録とチェーン連結され、改ざんや削除は即座に検知されます",
  ...
  "es": {
    ...
    "compliance.moat1.title": "Cadena de Hash a Prueba de Manipulaciones",
    ...
    "compliance.moat2.desc": "Marcas de tiempo UTC con números de secuencia monótonos que impiden retrofechado, huecos o reordenamiento",
  ...
  "fr": {
    ...
    "compliance.moat1.title": "Chaîne de Hachage Inviolable",
  ...
  "de": {
    ...
    "compliance.moat1.title": "Manipulationssichere Hash-Kette",
  ...
  "it": {
    ...
    "compliance.moat1.title": "Catena di Hash a Prova di Manomissione",
  ...
  "pt": {
    ...
    "compliance.moat1.title": "Cadeia de Hash à Prova de Adulteração",
    ...
    "compliance.moat3.desc": "Os registros só podem ser adicionados, nunca editados ou excluídos — totalmente exportável para descoberta jurídica e revisão regulatória",
