...
const translations = {
  "zh-TW": {
    ...
    "compliance.lead": "從圖紙解析到現場驗證，每個動作都寫入竄改可偵測的稽核鏈，滿足大型營造集團與政府標案的法遵要求。",
  ...
  "en": {
    ...
    "compliance.lead": "From drawing parsing to field verification, every action is written to a tamper-evident audit chain — built to satisfy large contractor groups and government-tender compliance requirements.",
  ...
  "ja": {
    ...
    "compliance.lead": "図面解析から現場検証まで、すべての操作は改ざんを検知可能な監査チェーンに記録され、大手建設グループや公共工事の法令遵守要件を満たします。",
  ...
  "es": {
    ...
    "compliance.lead": "Desde el análisis de planos hasta la verificación en obra, cada acción se escribe en una cadena de auditoría con integridad verificable, diseñada para cumplir los requisitos de grandes constructoras y licitaciones públicas.",
  ...
  "fr": {
    ...
    "compliance.lead": "De l'analyse des plans à la vérification sur site, chaque action est inscrite dans une chaîne d'audit à intégrité vérifiable, conçue pour répondre aux exigences des grands groupes de construction et des marchés publics.",
  ...
  "de": {
    ...
    "compliance.lead": "Von der Plananalyse bis zur Baustellenverifizierung wird jede Aktion in eine manipulationserkennbare Audit-Kette geschrieben — konzipiert, um die Compliance-Anforderungen großer Baukonzerne und öffentlicher Ausschreibungen zu erfüllen.",
  ...
  "it": {
    ...
    "compliance.lead": "Dall'analisi dei disegni alla verifica in cantiere, ogni azione viene scritta in una catena di audit a manomissione rilevabile, pensata per soddisfare i requisiti di conformità di grandi gruppi edili e gare d'appalto pubbliche.",
  ...
  "pt": {
    ...
    "compliance.lead": "Da análise de desenhos à verificação em obra, cada ação é gravada numa cadeia de auditoria com integridade verificável, criada para atender aos requisitos de conformidade de grandes construtoras e licitações públicas.",
