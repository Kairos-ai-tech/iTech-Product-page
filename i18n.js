...
const translations = {
  "zh-TW": {
    ...
    "compliance.lead": "從圖紙解析到現場驗證，每個動作都寫入竄改可偵測的稽核鏈，支援大型營造集團與政府標案的稽核審查需求。",
    ...
    "advantage.moat3.desc": "支援公共工程稽核審查需求，主動參與制定智慧工地竣工紀錄標準",
    ...
    "faq.q2.a": "鋼筋估算自動化系統已上線：AutoCAD 2021 外掛與跨平台桌面版，將結構施工圖直接轉換為加工圖與計料表 (.xlsm)，可直接匯入加工廠既有巨集工具，樑柱辨識率 ≥ 90%。AR 現場指導、AI 竣工驗證與法遵稽核鏈正在開發中。",
    ...
    "faq.q6.a": "不能。稽核鏈是技術性防竄改機制（SHA-256 雜湊鏈），可偵測竄改與刪除，但不構成對任何特定法規、驗收基準或政府標案要求之合規保證。實際法遵義務依個案適用法規及契約條款而定，建議就個案洽詢法律顧問；本頁面內容不構成法律意見。",
  ...
  "en": {
    ...
    "compliance.lead": "From drawing parsing to field verification, every action is written to a tamper-evident audit chain — built to support the audit-review needs of large contractor groups and government tenders.",
    "compliance.moat1.title": "Tamper-Evident Hash Chain",
    "compliance.moat1.desc": "Every entry is SHA-256 chained to the one before it — any edit or deletion is instantly detectable",
    "compliance.moat2.title": "Precise Timestamping",
    "compliance.moat2.desc": "UTC timestamps with monotonic sequence numbers rule out backdating, gaps, or reordering",
    "compliance.moat3.title": "Append-Only Audit Trail",
    "compliance.moat3.desc": "Entries can only be added, never edited or deleted — fully exportable for legal discovery and regulatory review",
    "compliance.moat4.title": "Long-Term Retention Architecture",
    "compliance.moat4.desc": "Schema-versioned records stay fully verifiable across multi-year retention windows",
    ...
    "advantage.moat3.desc": "Supports public-works audit-review needs; helping shape smart-site as-built standards",
    ...
    "faq.q2.a": "The Rebar Estimation Automation System is shipping now: an AutoCAD 2021 plugin plus a cross-platform desktop app that converts structural drawings directly into shop drawings and a material-list workbook (.xlsm), importing natively into a fabricator's existing macro tooling, with beam/column recognition ≥ 90%. AR field guidance, AI as-built verification, and the law/compliance audit trail are in development.",
    ...
    "faq.q6.a": "No. The audit trail is a technical tamper-evidence mechanism (SHA-256 hash chain) that detects alteration or deletion; it is not a certification of compliance with any specific law, regulation, or government tender requirement. Actual compliance obligations depend on applicable law and contract terms — consult your own legal counsel. Nothing on this page constitutes legal advice.",
  ...
  "ja": {
    ...
    "compliance.lead": "図面解析から現場検証まで、すべての操作は改ざんを検知可能な監査チェーンに記録され、大手建設グループや公共工事の監査対応ニーズを支援します。",
    "compliance.moat1.title": "改ざん検知可能なハッシュチェーン",
    "compliance.moat1.desc": "各記録は SHA-256 で前の記録とチェーン連結され、改ざんや削除は即座に検知可能",
    "compliance.moat2.title": "正確なタイムスタンプ",
    "compliance.moat2.desc": "UTC タイムスタンプと連続シーケンス番号により、遡及記入・欠番・時系列改ざんを防止",
    "compliance.moat3.title": "追記専用の監査記録",
    "compliance.moat3.desc": "記録は追加のみ可能で編集・削除不可。法的証拠や監督機関の査察向けに完全出力可能",
    "compliance.moat4.title": "長期保存対応アーキテクチャ",
    "compliance.moat4.desc": "記録形式はバージョン管理され、複数年にわたる保存期間でも完全に検証・復元可能",
    ...
    "advantage.moat3.desc": "公共工事の監査対応ニーズを支援、スマート現場の竣工記録標準策定にも参画",
    ...
    "faq.q2.a": "鉄筋積算自動化システムは提供中です。AutoCAD 2021プラグインとクロスプラットフォームのデスクトップ版で、構造施工図を施工図と計量表（.xlsm）に直接変換し、加工工場の既存マクロツールに取り込めます。梁・柱の認識率は90%以上。AR現場指導、AI竣工検証、および法令遵守監査チェーンは開発中です。",
    ...
    "faq.q6.a": "いいえ。監査チェーンは改ざんや削除を検知する技術的な仕組み（SHA-256ハッシュチェーン）であり、特定の法令・規制・政府調達要件への準拠を保証するものではありません。実際のコンプライアンス義務は適用法令および契約条件によって異なります。個別の状況については弁護士にご相談ください。本ページの内容は法的助言を構成するものではありません。",
    "pilot.label": "無料パイロット",
  ...
  "es": {
    ...
    "compliance.lead": "Desde el análisis de planos hasta la verificación en obra, cada acción se escribe en una cadena de auditoría con integridad verificable, diseñada para respaldar las necesidades de revisión de auditoría de grandes constructoras y licitaciones públicas.",
    "compliance.moat1.title": "Cadena de Hash con Integridad Verificable",
    "compliance.moat1.desc": "Cada registro se encadena mediante SHA-256 al anterior; cualquier edición o eliminación se detecta al instante",
    "compliance.moat2.title": "Marca de Tiempo Precisa",
    "compliance.moat2.desc": "Marcas de tiempo UTC con números de secuencia monótonos que impiden retrodatación, huecos o reordenamiento",
    "compliance.moat3.title": "Registro de Auditoría de Solo Adición",
    "compliance.moat3.desc": "Los registros solo pueden añadirse, nunca editarse ni eliminarse; exportable para litigios y revisión regulatoria",
    "compliance.moat4.title": "Arquitectura de Retención a Largo Plazo",
    "compliance.moat4.desc": "Los registros con versión de esquema siguen siendo verificables en periodos de retención de varios años",
    ...
    "advantage.moat3.desc": "Respalda las necesidades de revisión de auditoría de obra pública; ayuda a definir estándares de registro as-built para obras inteligentes",
    ...
    "faq.q6.a": "No. La cadena de auditoría es un mecanismo técnico de detección de manipulaciones (cadena de hash SHA-256) que detecta alteraciones o eliminaciones; no es una certificación de cumplimiento con ninguna ley, normativa o requisito de contratación pública específicos. Las obligaciones reales de cumplimiento dependen de la legislación aplicable y de los términos contractuales; consulte con su propio asesor legal. Nada en esta página constituye asesoramiento legal.",
  ...
  "fr": {
    ...
    "compliance.lead": "De l'analyse des plans à la vérification sur site, chaque action est inscrite dans une chaîne d'audit à intégrité vérifiable, conçue pour appuyer les besoins de revue d'audit des grands groupes de construction et des marchés publics.",
    "compliance.moat1.title": "Chaîne de Hachage à Intégrité Vérifiable",
    "compliance.moat1.desc": "Chaque entrée est chaînée par SHA-256 à la précédente ; toute modification ou suppression est immédiatement détectable",
    "compliance.moat2.title": "Horodatage Précis",
    "compliance.moat2.desc": "Horodatage UTC avec numéros de séquence monotones excluant l'antidatage, les trous ou la réorganisation",
    "compliance.moat3.title": "Journal d'Audit en Ajout Seul",
    "compliance.moat3.desc": "Les entrées ne peuvent être qu'ajoutées, jamais modifiées ni supprimées — exportable pour litiges et contrôles réglementaires",
    "compliance.moat4.title": "Architecture de Conservation à Long Terme",
    "compliance.moat4.desc": "Les enregistrements versionnés restent entièrement vérifiables sur des périodes de conservation pluriannuelles",
    ...
    "advantage.moat3.desc": "Appuie les besoins de revue d'audit des marchés publics ; contribue à définir les normes de dossier des ouvrages exécutés pour les chantiers intelligents",
  ...
  "de": {
    ...
    "compliance.lead": "Von der Plananalyse bis zur Baustellenverifizierung wird jede Aktion in eine manipulationserkennbare Audit-Kette geschrieben — konzipiert, um die Audit-Review-Anforderungen großer Baukonzerne und öffentlicher Ausschreibungen zu unterstützen.",
    "compliance.moat1.title": "Manipulationserkennbare Hash-Kette",
    "compliance.moat1.desc": "Jeder Eintrag ist per SHA-256 mit dem vorherigen verkettet — jede Änderung oder Löschung ist sofort erkennbar",
    "compliance.moat2.title": "Präzise Zeitstempel",
    "compliance.moat2.desc": "UTC-Zeitstempel mit fortlaufenden Sequenznummern schließen Rückdatierung, Lücken oder Umordnung aus",
    "compliance.moat3.title": "Nur-Anhängen-Audit-Protokoll",
    "compliance.moat3.desc": "Einträge können nur hinzugefügt, nie bearbeitet oder gelöscht werden — vollständig exportierbar für Rechtsverfahren und behördliche Prüfungen",
    "compliance.moat4.title": "Architektur für Langzeitarchivierung",
    "compliance.moat4.desc": "Versionierte Datensätze bleiben über mehrjährige Aufbewahrungsfristen hinweg vollständig verifizierbar",
    ...
    "advantage.moat3.desc": "Unterstützt die Audit-Review-Anforderungen öffentlicher Auftraggeber; wirkt an Standards für Bestandsdokumentation auf Smart-Baustellen mit",
    ...
    "faq.q6.a": "Nein. Die Audit-Kette ist ein technischer Mechanismus zur Erkennung von Manipulationen (SHA-256-Hash-Kette), der Änderungen oder Löschungen erkennt; sie ist keine Zertifizierung der Einhaltung eines bestimmten Gesetzes, einer Vorschrift oder einer Vergabeanforderung. Die tatsächlichen Compliance-Pflichten richten sich nach geltendem Recht und den Vertragsbedingungen; wenden Sie sich an Ihren eigenen Rechtsberater. Nichts auf dieser Seite stellt eine Rechtsberatung dar.",
  ...
  "it": {
    ...
    "compliance.lead": "Dall'analisi dei disegni alla verifica in cantiere, ogni azione viene scritta in una catena di audit a manomissione rilevabile, pensata per supportare le esigenze di revisione di audit di grandi gruppi edili e gare d'appalto pubbliche.",
    "compliance.moat1.title": "Catena di Hash a Manomissione Rilevabile",
    "compliance.moat1.desc": "Ogni voce è concatenata con SHA-256 a quella precedente; qualsiasi modifica o eliminazione è rilevata istantaneamente",
    "compliance.moat2.title": "Marcatura Temporale Precisa",
    "compliance.moat2.desc": "Timestamp UTC con numeri di sequenza monotoni che escludono retrodatazioni, lacune o riordinamenti",
    "compliance.moat3.title": "Registro di Audit Solo in Aggiunta",
    "compliance.moat3.desc": "Le voci possono essere solo aggiunte, mai modificate o eliminate — esportabile per contenziosi legali e verifiche regolatorie",
    "compliance.moat4.title": "Architettura per Conservazione a Lungo Termine",
    "compliance.moat4.desc": "I record con versione dello schema restano completamente verificabili su periodi di conservazione pluriennali",
    ...
    "advantage.moat3.desc": "Supporta le esigenze di revisione di audit delle opere pubbliche; contribuisce a definire gli standard di registro as-built per i cantieri intelligenti",
    ...
    "faq.q6.a": "No. La catena di audit è un meccanismo tecnico di rilevamento delle manomissioni (catena di hash SHA-256) che rileva alterazioni o cancellazioni; non è una certificazione di conformità a una legge, normativa o requisito di appalto pubblico specifico. Gli effettivi obblighi di conformità dipendono dalla legge applicabile e dai termini contrattuali; consultare un proprio legale. Nulla in questa pagina costituisce consulenza legale.",
  ...
  "pt": {
    ...
    "compliance.lead": "Da análise de desenhos à verificação em obra, cada ação é gravada numa cadeia de auditoria com integridade verificável, criada para apoiar as necessidades de revisão de auditoria de grandes construtoras e licitações públicas.",
    ...
    "compliance.moat4.desc": "Registros com versão de esquema permanecem totalmente verificáveis em janelas de retenção plurianuais",
    ...
    "advantage.moat3.desc": "Apoia as necessidades de revisão de auditoria de obras públicas; ajuda a definir padrões de registro as-built para canteiros inteligentes",
    ...
    "faq.q6.a": "Não. A cadeia de auditoria é um mecanismo técnico de detecção de adulteração (cadeia de hash SHA-256) que detecta alterações ou exclusões; não é uma certificação de conformidade com qualquer lei, regulamento ou requisito de licitação pública específico. As obrigações reais de conformidade dependem da legislação aplicável e dos termos contratuais; consulte seu próprio advogado. Nada nesta página constitui aconselhamento jurídico.",
    "pilot.label": "PILOTO GRATUITO",
