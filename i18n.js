...
const translations = {
  ...
  "es": {
    ...
    "compliance.lead": "Desde el análisis de planos hasta la verificación en obra, cada acción se escribe en una cadena de auditoría con manipulaciones detectables, diseñada para cumplir los requisitos de grandes constructoras y licitaciones públicas.",
    "compliance.moat1.title": "Cadena de Hash con Manipulaciones Detectables",
  ...
  "pt": {
    ...
    "compliance.lead": "Da análise de desenhos à verificação em obra, cada ação é gravada numa cadeia de auditoria com adulteração detectável, criada para atender aos requisitos de conformidade de grandes construtoras e licitações públicas.",
