...
const translations = {
  "zh-TW": {
    ...
    "compliance.heading": ["每一筆紀錄，禁得起稽核與法律檢驗"],
    ...
    "faq.q6.a": "不能。稽核鏈是技術性防竄改機制（SHA-256 雜湊鏈），可偵測竄改與刪除，但不構成對任何特定法規、驗收基準或政府標案要求之合規保證。實際法遵義務依個案適用法規及契約條款而定，建議洽詢法律顧問。",
  ...
  "en": {
    ...
    "compliance.heading": ["Every Record Survives Audit and Legal Scrutiny"],
    ...
    "faq.q6.a": "No. The audit trail is a technical tamper-evidence mechanism (SHA-256 hash chain) that detects alteration or deletion; it is not a certification of compliance with any specific law, regulation, or government tender requirement. Actual compliance obligations depend on applicable law and contract terms — consult your own legal counsel.",
  ...
  "ja": {
    ...
    "compliance.heading": ["すべての記録が監査と法的検証に耐える"],
    ...
    "faq.q6.a": "いいえ。監査チェーンは改ざんや削除を検知する技術的な仕組み（SHA-256ハッシュチェーン）であり、特定の法令・規制・政府調達要件への準拠を保証するものではありません。実際のコンプライアンス義務は適用法令および契約条件によって異なります。個別の状況については弁護士にご相談ください。",
    "pilot.label": "無料パイロット",
  ...
  "es": {
    ...
    "compliance.heading": ["Cada Registro Resiste Auditorías y Escrutinio Legal"],
  ...
  "fr": {
    ...
    "compliance.heading": ["Chaque Enregistrement Résiste à l'Audit et au Contrôle Juridique"],
  ...
  "de": {
    ...
    "compliance.heading": ["Jeder Eintrag Besteht Audit und Rechtsprüfung"],
  ...
  "it": {
    ...
    "compliance.heading": ["Ogni Registrazione Resiste ad Audit e Verifica Legale"],
  ...
  "pt": {
    ...
    "compliance.heading": ["Cada Registro Resiste a Auditorias e Escrutínio Legal"],
