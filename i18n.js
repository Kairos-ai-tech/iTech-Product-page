...
const translations = {
  "zh-TW": {
    ...
    "compliance.lead": "從圖紙解析到現場驗證，每個動作都寫入不可竄改的稽核鏈，滿足大型營造集團與政府標案的法遵要求。",
    "compliance.m1.title": "不可竄改鏈式雜湊",
    "compliance.m1.desc": "每筆紀錄以 SHA-256 串接前一筆雜湊，任何竄改或刪除立即可被偵測",
    "compliance.m2.title": "精確時間戳記",
    "compliance.m2.desc": "UTC 時間戳配合連續序號，杜絕事後補登、跳號或竄改時序",
    "compliance.m3.title": "唯讀式稽核紀錄",
    "compliance.m3.desc": "僅可新增、不可修改或刪除，可完整匯出供法律取證與主管機關查核",
    "compliance.m4.title": "長期保存相容架構",
    "compliance.m4.desc": "紀錄格式具版本控管，確保跨年度保存週期仍可完整驗證還原",
  ...
  "en": {
    ...
    "compliance.m1.title": "Tamper-Evident Hash Chain",
    "compliance.m1.desc": "Every entry is SHA-256 chained to the one before it — any edit or deletion is instantly detectable",
    "compliance.m2.title": "Precise Timestamping",
    "compliance.m2.desc": "UTC timestamps with monotonic sequence numbers rule out backdating, gaps, or reordering",
    "compliance.m3.title": "Append-Only Audit Trail",
    "compliance.m3.desc": "Entries can only be added, never edited or deleted — fully exportable for legal discovery and regulatory review",
    "compliance.m4.title": "Long-Term Retention Architecture",
    "compliance.m4.desc": "Schema-versioned records stay fully verifiable across multi-year retention windows",
  ...
  "ja": {
    ...
    "compliance.lead": "図面解析から現場検証まで、すべての操作は改ざん不可能な監査チェーンに記録され、大手建設グループや公共工事の法令遵守要件を満たします。",
    "compliance.m1.title": "改ざん検知可能なハッシュチェーン",
    "compliance.m1.desc": "各記録は SHA-256 で前の記録とチェーン連結され、改ざんや削除は即座に検知されます",
    "compliance.m2.title": "正確なタイムスタンプ",
    "compliance.m2.desc": "UTC タイムスタンプと連続シーケンス番号により、遡及記入・欠番・時系列改ざんを防止",
    "compliance.m3.title": "追記専用の監査記録",
    "compliance.m3.desc": "記録は追加のみ可能で編集・削除不可。法的証拠や監督機関の査察向けに完全出力可能",
    "compliance.m4.title": "長期保存対応アーキテクチャ",
    "compliance.m4.desc": "記録形式はバージョン管理され、複数年にわたる保存期間でも完全に検証・復元可能",
  ...
  "es": {
    ...
    "compliance.lead": "Desde el análisis de planos hasta la verificación en obra, cada acción se escribe en una cadena de auditoría a prueba de manipulaciones, diseñada para cumplir los requisitos de grandes constructoras y licitaciones públicas.",
    "compliance.m1.title": "Cadena de Hash a Prueba de Manipulaciones",
    "compliance.m1.desc": "Cada registro se encadena mediante SHA-256 al anterior; cualquier edición o eliminación se detecta al instante",
    "compliance.m2.title": "Marca de Tiempo Precisa",
    "compliance.m2.desc": "Marcas de tiempo UTC con números de secuencia monótonos que impiden retrofechado, huecos o reordenamiento",
    "compliance.m3.title": "Registro de Auditoría de Solo Adición",
    "compliance.m3.desc": "Los registros solo pueden añadirse, nunca editarse ni eliminarse; exportable para litigios y revisión regulatoria",
    "compliance.m4.title": "Arquitectura de Retención a Largo Plazo",
    "compliance.m4.desc": "Los registros con versión de esquema siguen siendo verificables en periodos de retención de varios años",
  ...
  "fr": {
    ...
    "compliance.lead": "De l'analyse des plans à la vérification sur site, chaque action est inscrite dans une chaîne d'audit inviolable, conçue pour répondre aux exigences des grands groupes de construction et des marchés publics.",
    "compliance.m1.title": "Chaîne de Hachage Inviolable",
    "compliance.m1.desc": "Chaque entrée est chaînée par SHA-256 à la précédente ; toute modification ou suppression est immédiatement détectable",
    "compliance.m2.title": "Horodatage Précis",
    "compliance.m2.desc": "Horodatage UTC avec numéros de séquence monotones excluant l'antidatage, les trous ou la réorganisation",
    "compliance.m3.title": "Journal d'Audit en Ajout Seul",
    "compliance.m3.desc": "Les entrées ne peuvent être qu'ajoutées, jamais modifiées ni supprimées — exportable pour litiges et contrôles réglementaires",
    "compliance.m4.title": "Architecture de Conservation à Long Terme",
    "compliance.m4.desc": "Les enregistrements versionnés restent entièrement vérifiables sur des périodes de conservation pluriannuelles",
  ...
  "de": {
    ...
    "compliance.lead": "Von der Plananalyse bis zur Baustellenverifizierung wird jede Aktion in eine manipulationssichere Audit-Kette geschrieben — konzipiert, um die Compliance-Anforderungen großer Baukonzerne und öffentlicher Ausschreibungen zu erfüllen.",
    "compliance.m1.title": "Manipulationssichere Hash-Kette",
    "compliance.m1.desc": "Jeder Eintrag ist per SHA-256 mit dem vorherigen verkettet — jede Änderung oder Löschung ist sofort erkennbar",
    "compliance.m2.title": "Präzise Zeitstempel",
    "compliance.m2.desc": "UTC-Zeitstempel mit fortlaufenden Sequenznummern schließen Rückdatierung, Lücken oder Umordnung aus",
    "compliance.m3.title": "Nur-Anhängen-Audit-Protokoll",
    "compliance.m3.desc": "Einträge können nur hinzugefügt, nie bearbeitet oder gelöscht werden — vollständig exportierbar für Rechtsverfahren und behördliche Prüfungen",
    "compliance.m4.title": "Architektur für Langzeitarchivierung",
    "compliance.m4.desc": "Versionierte Datensätze bleiben über mehrjährige Aufbewahrungsfristen hinweg vollständig verifizierbar",
  ...
  "it": {
    ...
    "compliance.lead": "Dall'analisi dei disegni alla verifica in cantiere, ogni azione viene scritta in una catena di audit a prova di manomissione, pensata per soddisfare i requisiti di conformità di grandi gruppi edili e gare d'appalto pubbliche.",
    "compliance.m1.title": "Catena di Hash a Prova di Manomissione",
    "compliance.m1.desc": "Ogni voce è concatenata con SHA-256 a quella precedente; qualsiasi modifica o eliminazione è rilevata istantaneamente",
    "compliance.m2.title": "Marcatura Temporale Precisa",
    "compliance.m2.desc": "Timestamp UTC con numeri di sequenza monotoni che escludono retrodatazioni, lacune o riordinamenti",
    "compliance.m3.title": "Registro di Audit Solo in Aggiunta",
    "compliance.m3.desc": "Le voci possono essere solo aggiunte, mai modificate o eliminate — esportabile per contenziosi legali e verifiche regolatorie",
    "compliance.m4.title": "Architettura per Conservazione a Lungo Termine",
    "compliance.m4.desc": "I record con versione dello schema restano completamente verificabili su periodi di conservazione pluriennali",
  ...
  "pt": {
    ...
    "compliance.lead": "Da análise de desenhos à verificação em obra, cada ação é gravada numa cadeia de auditoria à prova de adulteração, criada para atender aos requisitos de conformidade de grandes construtoras e licitações públicas.",
    "compliance.m1.title": "Cadeia de Hash à Prova de Adulteração",
    "compliance.m1.desc": "Cada registro é encadeado via SHA-256 ao anterior; qualquer edição ou exclusão é detectada instantaneamente",
    "compliance.m2.title": "Carimbo de Tempo Preciso",
    "compliance.m2.desc": "Carimbos de tempo UTC com números de sequência monótonos que impedem retroatividade, lacunas ou reordenação",
    "compliance.m3.title": "Trilha de Auditoria Somente-Adição",
    "compliance.m3.desc": "Os registros só podem ser adicionados, nunca editados ou excluídos — totalmente exportável para descoberta jurídica e revisão regulatória",
    "compliance.m4.title": "Arquitetura de Retenção de Longo Prazo",
    "compliance.m4.desc": "Registros com versão de esquema permanecem totalmente verificáveis em janelas de retenção plurianuais",
